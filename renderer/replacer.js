const $destFilesName = document.querySelector('#dest-files-name')
const $destFilesList = document.querySelector('#dest-files-list')
const $replaceBtn = document.querySelector('#replace-btn')
const $replaceResult = document.querySelector('#replace-result')
const $loadDestBtn = document.querySelector('#load-dest-btn')
const $manualKey = document.querySelector('#manual-key')
...
const $loadConfigBtn = document.querySelector('#load-config-btn')
